...
\@x{}\moduleLeftDash\@xx{ {\MODULE} musical\_chairs}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
Notes: Adaptation of the model presented by \ensuremath{Nissanke} (99)
\end{cpar}%
\vshade{5.0}%
...
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} CHAIRS ,\, PLAYERS}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} activePlayers ,\, activeChairs ,\,}%
\@x{\@s{16.4} occupied ,\, music\_playing ,\, state}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} activePlayers ,\, activeChairs ,\, occupied
 ,\, music\_playing ,\, state {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ STATE\_ \.{\defeq} \{\@w{Start} ,\,\@w{Walking} ,\,\@w{Sitting}
 ,\,\@w{Won} \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} activePlayers\@s{4.1} \.{\subseteq} PLAYERS}%
\@x{\@s{16.4} \.{\land}\@s{9.74} activeChairs\@s{7.56} \.{\subseteq} CHAIRS}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} occupied \.{\in} [ activeChairs
 \.{\rightarrow} activePlayers ] \.{\cup} \{ {\langle} {\rangle} \}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} music\_playing \.{\in} {\BOOLEAN}\@s{4.1}}%
\@y{\@s{0}%
 whether music is playing
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{9.74} state \.{\in} STATE\_}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Initial state
...
\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} activePlayers \.{=} PLAYERS\@s{4.1}}%
\@y{\@s{0}%
 force all \ensuremath{activePlayers} and
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} activeChairs \.{=} CHAIRS\@s{15.62}}%
\@y{\@s{0}%
 \ensuremath{activeChairs} to be included
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} Cardinality ( activePlayers ) \.{>} 1}%
 \@x{\@s{16.4} \.{\land} Cardinality ( activePlayers ) \.{=} Cardinality (
 activeChairs ) \.{+} 1}%
\@x{\@s{16.4} \.{\land} occupied \.{=} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 initially the empty function
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} music\_playing \.{\in} {\BOOLEAN}}%
\@x{\@s{16.4} \.{\land} state \.{=}\@w{Start}}%
\@pvspace{8.0pt}%
\@x{ Walk \.{\defeq}}%
\@x{\@s{16.4} \.{\land} state \.{=}\@w{Start}}%
\@x{\@s{16.4} \.{\land} music\_playing}%
\@x{\@s{16.4} \.{\land} Cardinality ( activePlayers ) \.{>} 1}%
\@x{\@s{16.4} \.{\land} occupied \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\land} state \.{'} \.{=}\@w{Walking}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} activeChairs ,\, activePlayers
 ,\, music\_playing {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Sit \.{\defeq}}%
\@x{\@s{12.95} \.{\land} state \.{=}\@w{Walking}}%
\@x{\@s{12.95} \.{\land} {\lnot} music\_playing}%
 \@x{\@s{12.95} \.{\land} occupied \.{'} \.{\in} [ activeChairs
 \.{\rightarrow} activePlayers ]}%
\@x{\@s{12.95}}%
\@y{\@s{0}%
 each chair maps to only one player
}%
\@xx{}%
 \@x{\@s{12.95} \.{\land} \A\, c \.{\in} activeChairs ,\, p1 ,\, p2 \.{\in}
 activePlayers \.{:}}%
 \@x{\@s{28.17} occupied \.{'} [ c ] \.{=} p1 \.{\land} occupied \.{'} [ c ]
 \.{=} p2 \.{\implies} p1 \.{=} p2}%
\@x{\@s{12.95}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{12.95} \.{\land} \A\, p \.{\in} Range ( occupied \.{'} ) ,\, c1 ,\,
 c2 \.{\in} {\DOMAIN} occupied \.{'} \.{:}}%
 \@x{\@s{28.17} occupied \.{'} [ c1 ] \.{=} p \.{\land} occupied \.{'} [ c2 ]
 \.{=} p \.{\implies} c1 \.{=} c2}%
\@x{\@s{12.95}}%
\@y{\@s{0}%
 there\mbox{'}s a player that didn\mbox{'}t get to sit down
}%
\@xx{}%
\@x{\@s{12.95}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} \E\, p \.{\in} activePlayers}: \ensuremath{p
 \.{\notin} Range(occupied\.{'})
}}%
\@xx{}%
\@x{\@s{12.95} \.{\land} state \.{'} \.{=}\@w{Sitting}}%
 \@x{\@s{12.95} \.{\land} {\UNCHANGED} {\langle} activeChairs ,\,
 activePlayers ,\, music\_playing {\rangle}}%
\@pvspace{8.0pt}%
\@x{ EliminateLoser \.{\defeq}}%
\@x{\@s{16.4} \.{\land} state \.{=}\@w{Sitting}}%
\@x{\@s{16.4} \.{\land} Cardinality ( activePlayers ) \.{>} 1}%
 \@x{\@s{16.4} \.{\land} Cardinality ( activePlayers ) \.{-} Cardinality (
 Range ( occupied ) ) \.{=} 1}%
\@x{\@s{16.4} \.{\land} activePlayers \.{'} \.{=} Range ( occupied )}%
 \@x{\@s{16.4} \.{\land} activeChairs \.{'} \.{=} activeChairs
 \.{\,\backslash\,} \{ {\CHOOSE} c \.{\in} activeChairs \.{:} {\TRUE} \}}%
 \@x{\@s{16.4} \.{\land} Cardinality ( activeChairs \.{'} ) \.{=} Cardinality
 ( activeChairs ) \.{-} 1}%
\@x{\@s{16.4} \.{\land} occupied \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\land} state \.{'} \.{=}\@w{Start}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} music\_playing}%
\@pvspace{8.0pt}%
\@x{ Win \.{\defeq}}%
\@x{\@s{19.44} \.{\land} state \.{=}\@w{Sitting}}%
\@x{\@s{19.44} \.{\land} Cardinality ( activePlayers ) \.{=} 1}%
\@x{\@s{19.44} \.{\land} state \.{'} \.{=}\@w{Won}}%
\@pvspace{8.0pt}%
\@x{ ChangeMusicPlaying \.{\defeq}}%
\@x{\@s{16.4} \.{\land} music\_playing \.{'} \.{\in} {\BOOLEAN}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} activeChairs ,\, activePlayers
 ,\, state ,\, occupied {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Safety invariants
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ OneMorePlayerThanChairs \.{\defeq}}%
 \@x{\@s{16.4} Cardinality ( activePlayers ) \.{=} Cardinality ( activeChairs
 ) \.{+} 1}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ ExistentialLiveness \.{\defeq}}%
 \@x{\@s{16.4} \E\, p \.{\in} PLAYERS \.{:} {\Diamond} ( activePlayers \.{=}
 \{ p \} )}%
\@pvspace{8.0pt}%
\@x{ FiniteLiveness \.{\defeq} {\Diamond} {\ENABLED} Sit}%
\@pvspace{8.0pt}%
 \@x{ InfiniteLiveness \.{\defeq} {\Diamond} {\Box} ( Cardinality (
 activePlayers ) \.{=} 1 )}%
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} Walk}%
\@x{\@s{16.4} \.{\lor} Sit}%
\@x{\@s{16.4} \.{\lor} EliminateLoser}%
\@x{\@s{16.4} \.{\lor} Win}%
\@x{\@s{16.4} \.{\lor} ChangeMusicPlaying}%
\@pvspace{8.0pt}%
\@x{ PlayActions \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} Walk}%
\@x{\@s{16.4} \.{\lor} Sit}%
...
\@x{\@s{16.4} \.{\lor} Win}%
\@pvspace{8.0pt}%
 \@x{ Live \.{\defeq} {\SF}_{ vars} ( PlayActions ) \.{\land} {\WF}_{ vars} (
 ChangeMusicPlaying )}%
\@x{}%
\@y{%
 \ensuremath{Live \.{\defeq} {\TRUE} \.{\,\backslash\,}}* don\mbox{'}t assume
 fairness
}%
\@xx{}%
\@pvspace{8.0pt}%
 ...
 Live\@s{4.1}}%
\@y{\@s{0}%
 every transition either satisfies the action
}%
\@xx{}%
\@x{\@s{150.74}}%
\@y{\@s{0}%
 formula \ensuremath{Next} or leaves the expression
}%
\@xx{}%
\@x{\@s{150.74}}%
\@y{\@s{0}%
 \ensuremath{vars} unchanged. In particular, this admits
}%
\@xx{}%
\@x{\@s{150.74}}%
\@y{\@s{0}%
...
\@x{\@s{150.74}}%
\@y{\@s{0}%
 \ensuremath{vars} . That is to say,
}%
\@xx{}%
\@x{\@s{150.74}}%
\@y{\@s{0}%
 \ensuremath{{\Box}[Next]\_vars \.{\defeq} {\Box}(Next \.{\lor} (vars\.{'}
 \.{=} vars))
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 17 14:05:02 \ensuremath{EDT} 2018 by \ensuremath{amin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} May 14 11:12:23
