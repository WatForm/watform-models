...
begin
    reserve:
        when
            ...
            /\ ~(book \in DOMAIN loans /\ loans[book] = member)
            /\ \/ book \in DOMAIN loans
               \/ reservations[book] # <<>>;
...
begin
    take:
        when
            ...
            /\ book \in books
            /\ book \notin DOMAIN loans
            /\ Card(RanResBy(loans, member)) < maxNbLoans
...
\* Process variable member of process Cancel at line 35 col 11 changed to member_
\* Process variable book of process Cancel at line 36 col 11 changed to book_C
\* Process variable book of process Discard at line 51 col 10 changed to book_D
\* Process variable member of process Join at line 63 col 10 changed to member_J
\* Process variable member of process Leave at line 71 col 10 changed to member_L
\* Process variable member of process Lend at line 83 col 11 changed to member_Le
\* Process variable book of process Lend at line 84 col 11 changed to book_L
\* Process variable member of process Renew at line 97 col 11 changed to member_R
\* Process variable book of process Renew at line 98 col 11 changed to book_R
\* Process variable member of process Reserve at line 111 col 11 changed to member_Re
\* Process variable book of process Reserve at line 112 col 11 changed to book_Re
\* Process variable book of process Return at line 126 col 11 changed to book_Ret
...
acquire == /\ pc["Acquire"] = "acquire"
           ...
           /\ UNCHANGED << loans, members, book_, member_, book_C, book_D, 
...
reserve == /\ pc["Reserve"] = "reserve"
           /\ /\ member_Re \in members
              ...
              /\ ~(book_Re \in DOMAIN loans /\ loans[book_Re] = member_Re)
              /\ \/ book_Re \in DOMAIN loans
...
return_ == /\ pc["Return"] = "return_"
           /\ /\ book_Ret \in books
              /\ book_Ret \in DOMAIN loans
           /\ loans' = DomSubBy(book_Ret, loans)
...
ASSERT_LTL_6 ==
    [](ENABLED Reserve => ~(book_Re \in DOMAIN loans /\ loans[book_Re] = member_Re))
...
ASSERT_LTL_11 ==  \* not accurately represented, since TLA+ doesn't have W
    /\ [](\A b \in books:
        b \in DOMAIN loans => ~(ENABLED Take /\ book = b))
    /\ [](ENABLED Take => book \notin DOMAIN loans)
...
\* Last modified Sun May 31 19:34:29 EDT 2020 by bandali
