...
begin
    eliminateloser:
        ...
        if Cardinality(activePlayers) = 1 then
            goto Done
        else
            goto eliminateloser
        end if
...
eliminateloser == /\ pc["EliminateLoser"] = "eliminateloser"
                  ...
                  /\ state' = "Start"
                  /\ oldCard' = Cardinality(activeChairs')
                  /\ IF Cardinality(activePlayers') = 1
                        THEN /\ pc' = [pc EXCEPT !["EliminateLoser"] = "Done"]
                        ELSE /\ pc' = [pc EXCEPT !["EliminateLoser"] = "eliminateloser"]
                  /\ UNCHANGED musicPlaying
...
\* Last modified Mon Dec 23 01:05:24 EST 2019 by bandali
