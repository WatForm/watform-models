...
pred dsh_initial [s: one DshSnapshot, p0_ClientID: one ClientID, p1_CoordinatorID: one CoordinatorID, p2_PartLdrID: one PartLdrID] {
  (all p0_ClientID: one
  ...
  PartLdrID | (s . dsh_conf0) = none and
                ...
                (all disj p,q: PartLdrID | (p.(p2_PartLdrID
                                                 .
                                                 (s .
                ...
                no
                (p2_PartLdrID .
                   (s . Carousel_PartitionLeader_response)) and
                one
                (p2_PartLdrID .
                   (s . Carousel_PartitionLeader_pendingTxn)) and
                no
                (p2_PartLdrID .
                   (s . Carousel_PartitionLeader_currentTxn)) and
                no
                (p0_ClientID .
...
pred Carousel_Client_Waiting_FinalizeCommit_post [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  ...
  ((p0_ClientID -> Carousel_Client) .
   (none .
      (none .
         (none .
            (p0_ClientID . (sn . (s . _testIfNextStable)))))))=>
...
pred Carousel_Client_Waiting_FinalizeCommit_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
...
pred Carousel_Client_Waiting_FinalizeCommit [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  p0_ClientID .
  (s . Carousel_Client_Waiting_FinalizeCommit_pre)
  p0_ClientID .
  (sn . (s . Carousel_Client_Waiting_FinalizeCommit_post))
}

pred Carousel_PartitionLeader_Abort_AbortTransaction_pre [s: one DshSnapshot, p2_ClientID: one ClientID] {
  some
...
pred Carousel_PartitionLeader_Abort_AbortTransaction_post [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) -
...
pred Carousel_PartitionLeader_Abort_AbortTransaction_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Abort) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_PartitionLeader_Abort_AbortTransaction [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  p2_PartLdrID .
...
pred Carousel_Client_Reading_ReadAndPrepare_pre [s: one DshSnapshot, p0_ClientID: one ClientID] {
  some
...
pred Carousel_Client_Reading_ReadAndPrepare_post [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  ((((s . dsh_conf1) -
       (p0_ClientID -> Carousel_Client_Reading)) -
      (p0_ClientID -> Carousel_Client_Waiting)) +
     (p0_ClientID -> Carousel_Client_Waiting))
  (one t: p0_ClientID . (s . Carousel_Client_transToSend),c: CoordinatorID | (all leader: PartLdrID | (p0_ClientID
                                                                                                       .
                                                                                                       (sn
                                                                                                          .
                                                                                                          Carousel_Client_txn))
...
pred Carousel_Client_Reading_ReadAndPrepare_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
...
pred Carousel_Client_Reading_ReadAndPrepare [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  p0_ClientID .
  (s . Carousel_Client_Reading_ReadAndPrepare_pre)
  p0_ClientID .
  (sn . (s . Carousel_Client_Reading_ReadAndPrepare_post))
}

pred Carousel_Coordinator_WaitForResponse_StartAbort_pre [s: one DshSnapshot, p1_ClientID: one ClientID] {
  some
...
pred Carousel_Coordinator_WaitForResponse_StartAbort_post [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) -
      (p1_CoordinatorID ->
...
pred Carousel_Coordinator_WaitForResponse_StartAbort_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p1_CoordinatorID -> Carousel_Coordinator_WaitForResponse)
   & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_Coordinator_WaitForResponse_StartAbort [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  p1_CoordinatorID .
...
pred Carousel_PartitionLeader_Waiting_PrepareCommit_pre [s: one DshSnapshot, p2_ClientID: one ClientID] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (s . dsh_conf1))
  some
...
pred Carousel_PartitionLeader_Waiting_PrepareCommit_post [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) -
        (p2_PartLdrID -> Carousel_PartitionLeader_Waiting))
      ...
      - (p2_PartLdrID -> Carousel_PartitionLeader_Abort)) +
     (p2_PartLdrID -> Carousel_PartitionLeader_Commit))
  ((p2_PartLdrID . (s . Carousel_PartitionLeader_currentTxn)).firstElem).((p2_PartLdrID
                                                                           .
                                                                           (s
                                                                              .
...
pred Carousel_PartitionLeader_Waiting_PrepareCommit_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_PartitionLeader_Waiting_PrepareCommit [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  p2_PartLdrID .
...
pred Carousel_Coordinator_WaitForResponse_StartCommit_pre [s: one DshSnapshot, p1_ClientID: one ClientID] {
  some
((p1_CoordinatorID -> Carousel_Coordinator_WaitForResponse)
   & (s . dsh_conf1))
  (#
...
pred Carousel_Coordinator_WaitForResponse_StartCommit_post [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) -
      (p1_CoordinatorID ->
...
pred Carousel_Coordinator_WaitForResponse_StartCommit_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p1_CoordinatorID -> Carousel_Coordinator_WaitForResponse)
   & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_Coordinator_WaitForResponse_StartCommit [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  p1_CoordinatorID .
...
pred Carousel_Client_Waiting_FinalizeAbort_pre [s: one DshSnapshot, p0_ClientID: one ClientID] {
  some
((p0_ClientID -> Carousel_Client_Waiting) & (s . dsh_conf1))
  one
  (p0_ClientID . (s . Carousel_Client_response)) and
...
pred Carousel_Client_Waiting_FinalizeAbort_post [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  ((((s . dsh_conf1) -
       (p0_ClientID -> Carousel_Client_Reading)) -
...
pred Carousel_Client_Waiting_FinalizeAbort_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_ClientID -> Carousel_Client_Waiting) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred Carousel_Client_Waiting_FinalizeAbort [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID] {
  p0_ClientID .
  (s . Carousel_Client_Waiting_FinalizeAbort_pre)
  p0_ClientID .
  (sn . (s . Carousel_Client_Waiting_FinalizeAbort_post))
}

pred Carousel_PartitionLeader_Waiting_FinalizeCommit_pre [s: one DshSnapshot, p2_ClientID: one ClientID] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (s . dsh_conf1))
  Commit in
  (Transaction.(p2_PartLdrID .
...
pred Carousel_PartitionLeader_Waiting_FinalizeCommit_post [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) -
      (p2_PartLdrID -> Carousel_PartitionLeader_Waiting)) +
...
pred Carousel_PartitionLeader_Waiting_FinalizeCommit_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_PartitionLeader_Waiting_FinalizeCommit [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  p2_PartLdrID .
...
pred Carousel_PartitionLeader_Waiting_PrepareAbort_pre [s: one DshSnapshot, p2_ClientID: one ClientID] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (s . dsh_conf1))
  some
...
pred Carousel_PartitionLeader_Waiting_PrepareAbort_post [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) -
        (p2_PartLdrID -> Carousel_PartitionLeader_Waiting))
...
pred Carousel_PartitionLeader_Waiting_PrepareAbort_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Waiting) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_PartitionLeader_Waiting_PrepareAbort [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  p2_PartLdrID .
...
pred Carousel_Coordinator_Replicate_Replicating_pre [s: one DshSnapshot, p1_ClientID: one ClientID] {
  some
...
pred Carousel_Coordinator_Replicate_Replicating_post [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  ((((s . dsh_conf1) -
       (p1_CoordinatorID -> Carousel_Coordinator_Replicate))
...
pred Carousel_Coordinator_Replicate_Replicating_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p1_CoordinatorID -> Carousel_Coordinator_Replicate) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_Coordinator_Replicate_Replicating [s: one DshSnapshot, sn: one DshSnapshot, p1_CoordinatorID: one CoordinatorID] {
  p1_CoordinatorID .
...
pred Carousel_PartitionLeader_Commit_CommitTransaction_pre [s: one DshSnapshot, p2_ClientID: one ClientID] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Commit) &
   (s . dsh_conf1))
  ! (Carousel in (s . dsh_sc_used0))
...
pred Carousel_PartitionLeader_Commit_CommitTransaction_post [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) -
        (p2_PartLdrID -> Carousel_PartitionLeader_Waiting))
      ...
      - (p2_PartLdrID -> Carousel_PartitionLeader_Abort)) +
     (p2_PartLdrID -> Carousel_PartitionLeader_Waiting))
  ((((p2_PartLdrID . (s . Carousel_PartitionLeader_pendingTxn)).firstElem).coordinator)
   . (sn . Carousel_Coordinator_coord_responses)) =
  (((((p2_PartLdrID .
...
pred Carousel_PartitionLeader_Commit_CommitTransaction_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p2_PartLdrID -> Carousel_PartitionLeader_Commit) &
   (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
...
pred Carousel_PartitionLeader_Commit_CommitTransaction [s: one DshSnapshot, sn: one DshSnapshot, p2_PartLdrID: one PartLdrID] {
  p2_PartLdrID .
...
pred _testIfNextStable [s: one DshSnapshot, sn: one DshSnapshot, p0_ClientID: one ClientID, p1_CoordinatorID: one CoordinatorID, p2_PartLdrID: one PartLdrID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  !
(dsh_scp1 .
   (dsh_scp0 .
      (sn .
