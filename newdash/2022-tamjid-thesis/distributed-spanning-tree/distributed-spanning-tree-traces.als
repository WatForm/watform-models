...
pred DistrubedTreeSpanning_N_Assigned_sendMessage_post [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node] {
...
pred DistrubedTreeSpanning_N_Assigned_sendMessage_enabledAfterStep [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node,
	dsh_scp0: DshStates,
...
pred DistrubedTreeSpanning_N_Assigned_sendMessage [
	...
	sn: one DshSnapshot,
	p0_Node: one Node] {
  p0_Node.(s.DistrubedTreeSpanning_N_Assigned_sendMessage_pre)
  p0_Node.(sn.(s.DistrubedTreeSpanning_N_Assigned_sendMessage_post))
}

pred DistrubedTreeSpanning_N_Unassigned_RootAssign_pre [
	s: one DshSnapshot,
	p0_Node: one Node] {
  some
...
pred DistrubedTreeSpanning_N_Unassigned_RootAssign_post [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node] {
  (sn.dsh_conf0) = (s.dsh_conf0)
...
pred DistrubedTreeSpanning_N_Unassigned_RootAssign_enabledAfterStep [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node,
	dsh_scp0: DshStates,
...
pred DistrubedTreeSpanning_N_Unassigned_RootAssign [
	...
	sn: one DshSnapshot,
	p0_Node: one Node] {
  p0_Node.(s.DistrubedTreeSpanning_N_Unassigned_RootAssign_pre)
  p0_Node.(sn.(s.DistrubedTreeSpanning_N_Unassigned_RootAssign_post))
}

pred DistrubedTreeSpanning_N_Unassigned_NodeAssign_pre [
	s: one DshSnapshot,
	p0_Node: one Node] {
  some
((p0_Node -> DistrubedTreeSpanning_N_Unassigned) &
...
pred DistrubedTreeSpanning_N_Unassigned_NodeAssign_post [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node] {
  (sn.dsh_conf0) = (s.dsh_conf0)
...
pred DistrubedTreeSpanning_N_Unassigned_NodeAssign_enabledAfterStep [
	s: one DshSnapshot,
	sn: one DshSnapshot,
	p0_Node: one Node,
	dsh_scp0: DshStates,
...
pred DistrubedTreeSpanning_N_Unassigned_NodeAssign [
	...
	sn: one DshSnapshot,
	p0_Node: one Node] {
  p0_Node.(s.DistrubedTreeSpanning_N_Unassigned_NodeAssign_pre)
  p0_Node.(sn.(s.DistrubedTreeSpanning_N_Unassigned_NodeAssign_post))
}
...
pred dsh_small_step [
	...
	sn: one DshSnapshot] {
  (some p0_Node: one
  Node | { p0_Node.(sn.(s.DistrubedTreeSpanning_N_Assigned_sendMessage)) or
             p0_Node.(sn.(s.DistrubedTreeSpanning_N_Unassigned_RootAssign)) or
             p0_Node.(sn.(s.DistrubedTreeSpanning_N_Unassigned_NodeAssign)) })
}
