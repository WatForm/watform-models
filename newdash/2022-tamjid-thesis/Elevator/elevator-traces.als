...
pred System_Elevator_MovingUp_ChangeDirToDown_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingUp) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
  no
...
pred System_Elevator_MovingUp_ChangeDirToDown_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
...
pred System_Elevator_MovingUp_ChangeDirToDown_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingUp) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
    !
...
pred System_Elevator_MovingUp_ChangeDirToDown [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingUp_ChangeDirToDown_pre)
  p0_PID .
  (sn . (s . System_Elevator_MovingUp_ChangeDirToDown_post))
}

pred System_Elevator_Idle_Move_pre [s: one DshSnapshot, p0_PID: one PID] {
...
pred System_Elevator_Idle_Move_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
       - (p0_PID -> System_Elevator_MovingDown)) -
...
pred System_Elevator_Idle_Move_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
...
pred System_Elevator_Idle_Move [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_Idle_Move_pre)
  p0_PID . (sn . (s . System_Elevator_Idle_Move_post))
}

pred System_Elevator_MovingDown_Idle_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
...
pred System_Elevator_MovingDown_Idle_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
       - (p0_PID -> System_Elevator_MovingDown)) -
...
pred System_Elevator_MovingDown_Idle_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
...
pred System_Elevator_MovingDown_Idle [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingDown_Idle_pre)
  p0_PID . (sn . (s . System_Elevator_MovingDown_Idle_post))
}

pred System_Elevator_MovingDown_MoveDown_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingDown) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_MovingDown_MoveDown_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
...
pred System_Elevator_MovingDown_MoveDown_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingDown) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingDown_MoveDown [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingDown_MoveDown_pre)
  p0_PID .
  (sn . (s . System_Elevator_MovingDown_MoveDown_post))
}

pred System_Elevator_Idle_DefaultToGround_pre [s: one DshSnapshot, p0_PID: one PID] {
  some ((p0_PID -> System_Elevator_Idle) & (s . dsh_conf1))
  no
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_Idle_DefaultToGround_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
...
pred System_Elevator_Idle_DefaultToGround_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some ((p0_PID -> System_Elevator_Idle) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
...
pred System_Elevator_Idle_DefaultToGround [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_Idle_DefaultToGround_pre)
  p0_PID .
  (sn . (s . System_Elevator_Idle_DefaultToGround_post))
}

pred System_Elevator_MovingUp_MoveUp_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingUp) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_MovingUp_MoveUp_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
     + (p0_PID -> System_Elevator_MovingUp))
...
pred System_Elevator_MovingUp_MoveUp_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingUp) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingUp_MoveUp [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingUp_MoveUp_pre)
  p0_PID . (sn . (s . System_Elevator_MovingUp_MoveUp_post))
}

pred System_Elevator_MovingUp_Idle_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingUp) & (s . dsh_conf1))
  no (p0_PID . (s . System_Elevator_called))
  ! (System in (s . dsh_sc_used0))
...
pred System_Elevator_MovingUp_Idle_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
       - (p0_PID -> System_Elevator_MovingDown)) -
...
pred System_Elevator_MovingUp_Idle_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingUp) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingUp_Idle [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingUp_Idle_pre)
  p0_PID . (sn . (s . System_Elevator_MovingUp_Idle_post))
}

pred System_Elevator_MovingDown_ElevatorInCalled_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingDown) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_MovingDown_ElevatorInCalled_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingDown))
     + (p0_PID -> System_Elevator_MovingDown))
...
pred System_Elevator_MovingDown_ElevatorInCalled_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingDown) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingDown_ElevatorInCalled [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID .
  (s . System_Elevator_MovingDown_ElevatorInCalled_pre)
  p0_PID .
  (sn .
     (s . System_Elevator_MovingDown_ElevatorInCalled_post))
}

pred System_Elevator_MovingDown_ChangeDirToUp_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingDown) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_MovingDown_ChangeDirToUp_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
       - (p0_PID -> System_Elevator_MovingDown)) -
...
pred System_Elevator_MovingDown_ChangeDirToUp_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingDown) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingDown_ChangeDirToUp [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
...
pred System_Elevator_MovingUp_ElevatorInCalled_pre [s: one DshSnapshot, p0_PID: one PID] {
  some
((p0_PID -> System_Elevator_MovingUp) & (s . dsh_conf1))
  some
  (p0_PID . (s . System_Elevator_called)) and
...
pred System_Elevator_MovingUp_ElevatorInCalled_post [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_PID -> System_Elevator_MovingUp))
     + (p0_PID -> System_Elevator_MovingUp))
...
pred System_Elevator_MovingUp_ElevatorInCalled_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some
((p0_PID -> System_Elevator_MovingUp) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
...
pred System_Elevator_MovingUp_ElevatorInCalled [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID] {
  p0_PID . (s . System_Elevator_MovingUp_ElevatorInCalled_pre)
  p0_PID .
  (sn . (s . System_Elevator_MovingUp_ElevatorInCalled_post))
}

pred _testIfNextStable [s: one DshSnapshot, sn: one DshSnapshot, p0_PID: one PID, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  !
(dsh_scp1 .
   (dsh_scp0 .
      (sn .
