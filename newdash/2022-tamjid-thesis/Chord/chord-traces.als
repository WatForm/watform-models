...
pred dsh_initial [
  ...
  Node | (s.dsh_conf0) = none and
           ...
           (p0_Node.(s.System_N_frst)) = (thisNode.nextNode) and
           (p0_Node.(s.System_N_scnd)) =
             ((p0_Node.(s.System_N_frst)).nextNode) and
           (p0_Node.(s.System_N_prdc)) = (thisNode.prevNode) and
...
pred System_N_Live_StabilizeFromPrdc_pre [
  ...
  (p0_Node.(s.System_N_frst)).((p0_Node.(s.System_N_saved)).(thisNode.between))
...
pred System_N_Live_StabilizeFromPrdc_post [
  ...
  ((p0_Node.(s.System_N_saved)) !in (s.System_members))=>
      (p0_Node.(sn.System_N_frst)) =
        ...
        (all n: Node - thisNode | (n.(sn.System_N_status)) =
  ...
  ((p0_Node.(s.System_N_frst)) !in (s.System_members))=>
    ...
    (p0_Node.(sn.System_N_frst)) =
      ...
      (some
         ...
         (p0_Node.(s.System_N_frst)).(((p0_Node.(s.System_N_frst)).(s.System_N_prdc)).(thisNode.between)) and
...
pred System_N_Live_Rectify_post [
  ...
  (((s.dsh_conf1) - (p0_Node -> System_N_Live)) +
     (p0_Node -> System_N_Live))
  ({ thisNode.((p0_Node.(s.System_N_saved)).((p0_Node.(s.System_N_prdc)).between)) or
...
pred _testIfNextStable [
	...
	dsh_scp0: DshStates,
	dsh_scp1: DshIds -> DshStates] {
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Live_StabilizeFromPrdc_enabledAfterStep))))
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Live_Flush_enabledAfterStep))))
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Live_Fail_enabledAfterStep))))
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Live_StabilizeFromSucc_enabledAfterStep))))
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Live_Rectify_enabledAfterStep))))
  !(dsh_scp1.(dsh_scp0.(sn.(s.System_N_Failed_Join_enabledAfterStep))))
}
