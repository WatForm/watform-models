...
pred System_N_Live_StabilizeFromPrdc_pre [s: one DshSnapshot, p0_Node: one Node] {
  ...
  thisNode in (s . System_members) and
  (p0_Node . (s . System_N_status)) = Stabilizing and
  (p0_Node . (s . System_N_frst)).((p0_Node .
                                      (s . System_N_saved)).(thisNode.between))
  ! (System in (s . dsh_sc_used0))
  ! ((p0_Node -> System_N) in (s . dsh_sc_used1))
}


pred System_N_Live_StabilizeFromPrdc_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  ...
  ((p0_Node . (s . System_N_saved)) !in (s . System_members))=>
      (p0_Node . (sn . System_N_frst)) =
        ...
        (all n: Node - thisNode | (n .
                                     (sn . System_N_status))
                                    =
                                    (n .
                                       (s . System_N_status))) and
        (all n: Node - thisNode | (n . (sn . System_N_saved))
                                    =
                                    (n .
                                       (s . System_N_saved)))
    else
      (p0_Node . (sn . System_N_frst)) =
        ...
        ((p0_Node . (s . System_N_saved)) .
           (sn . System_N_saved)) = thisNode and
        (all n: (Node - (p0_Node . (s . System_N_saved))) -
                  thisNode | (n . (sn . System_N_status)) =
                               (n . (s . System_N_status))) and
        (all n: (Node - (p0_Node . (s . System_N_saved))) -
                  thisNode | (n . (sn . System_N_saved)) =
                               (n . (s . System_N_saved)))
...
pred System_N_Live_StabilizeFromPrdc_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
...
pred System_N_Live_StabilizeFromPrdc [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  p0_Node . (s . System_N_Live_StabilizeFromPrdc_pre)
  p0_Node . (sn . (s . System_N_Live_StabilizeFromPrdc_post))
}

pred System_N_Live_Flush_pre [s: one DshSnapshot, p0_Node: one Node] {
  some ((p0_Node -> System_N_Live) & (s . dsh_conf1))
  thisNode in (s . System_members) and
...
pred System_N_Live_Flush_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_Node -> System_N_Live)) +
     (p0_Node -> System_N_Live))
...
pred System_N_Live_Flush_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some ((p0_Node -> System_N_Live) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
...
pred System_N_Live_Flush [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  p0_Node . (s . System_N_Live_Flush_pre)
  p0_Node . (sn . (s . System_N_Live_Flush_post))
}

pred System_N_Live_Fail_pre [s: one DshSnapshot, p0_Node: one Node] {
  some ((p0_Node -> System_N_Live) & (s . dsh_conf1))
  (all n: Node - thisNode | some
  (((s . System_members) - thisNode) &
...
pred System_N_Live_Fail_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  ((((s . dsh_conf1) - (p0_Node -> System_N_Live)) -
      (p0_Node -> System_N_Failed)) +
     (p0_Node -> System_N_Failed))
  (sn . System_members) = ((s . System_members) - thisNode) and
...
pred System_N_Live_Fail_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some ((p0_Node -> System_N_Live) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
...
pred System_N_Live_Fail [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  p0_Node . (s . System_N_Live_Fail_pre)
  p0_Node . (sn . (s . System_N_Live_Fail_post))
}

pred System_N_Live_StabilizeFromSucc_pre [s: one DshSnapshot, p0_Node: one Node] {
  some ((p0_Node -> System_N_Live) & (s . dsh_conf1))
...
pred System_N_Live_StabilizeFromSucc_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_Node -> System_N_Live)) +
     (p0_Node -> System_N_Live))
    ...
    (p0_Node . (sn . System_N_frst)) =
      ...
      (some
         ...
         (p0_Node . (s . System_N_frst)).(((p0_Node .
                                             ...
                                             .
                                             (s .
                                                System_N_prdc)).(thisNode.between)) and
         ((p0_Node . (s . System_N_frst)) .
...
pred System_N_Live_StabilizeFromSucc_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some ((p0_Node -> System_N_Live) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
...
pred System_N_Live_StabilizeFromSucc [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  p0_Node . (s . System_N_Live_StabilizeFromSucc_pre)
  p0_Node . (sn . (s . System_N_Live_StabilizeFromSucc_post))
}

pred System_N_Live_Rectify_pre [s: one DshSnapshot, p0_Node: one Node] {
  some ((p0_Node -> System_N_Live) & (s . dsh_conf1))
  thisNode in (s . System_members) and
...
pred System_N_Live_Rectify_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  (((s . dsh_conf1) - (p0_Node -> System_N_Live)) +
     (p0_Node -> System_N_Live))
  ({ thisNode.((p0_Node . (s . System_N_saved)).((p0_Node .
                                                  (s .
                                                     System_N_prdc)).between)) or
     (p0_Node . (s . System_N_prdc)) !in
       (s . System_members) or
     no
     (p0_Node . (s . System_N_prdc)) })=>
...
pred System_N_Live_Rectify_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
  some ((p0_Node -> System_N_Live) & (sn . dsh_conf1))
  { (s . dsh_stable) = boolean/True and
    !
    (System in dsh_scp0) and
...
pred System_N_Live_Rectify [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  p0_Node . (s . System_N_Live_Rectify_pre)
  p0_Node . (sn . (s . System_N_Live_Rectify_post))
}

pred System_N_Failed_Join_pre [s: one DshSnapshot, p0_Node: one Node] {
  some ((p0_Node -> System_N_Failed) & (s . dsh_conf1))
  thisNode !in (s . System_members)
  ! (System in (s . dsh_sc_used0))
  ! ((p0_Node -> System_N) in (s . dsh_sc_used1))
}


pred System_N_Failed_Join_post [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
  (sn . dsh_conf0) = (s . dsh_conf0)
  (sn . dsh_conf1) =
  ((((s . dsh_conf1) - (p0_Node -> System_N_Live)) -
      (p0_Node -> System_N_Failed)) +
     (p0_Node -> System_N_Live))
  (sn . System_members) = ((s . System_members) + thisNode)
  ((p0_Node -> System_N) .
   (none . (p0_Node . (sn . (s . _testIfNextStable)))))=>
    ((sn . dsh_stable) = boolean/True and
       (sn . dsh_sc_used0) = none and
...
pred System_N_Failed_Join_enabledAfterStep [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node, dsh_scp0: DshStates, dsh_scp1: DshIds -> DshStates] {
...
pred System_N_Failed_Join [s: one DshSnapshot, sn: one DshSnapshot, p0_Node: one Node] {
