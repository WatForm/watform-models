...
pred _testIfNextStable [
	...
	dsh_scp1: DshIds -> DshStates,
	dsh_genEvs1: DshIds -> DshEvents] {
  !(dsh_genEvs1.(dsh_scp1.(dsh_genEvs0.(dsh_scp0.(sn.(s.HeatingSystem_Functioning_Controller_Off_T8_enabledAfterStep))))))
  !(dsh_genEvs1.(dsh_scp1.(dsh_genEvs0.(dsh_scp0.(sn.(s.HeatingSystem_Functioning_Controller_On_Heater_Active_T10_enabledAfterStep))))))
  !(dsh_genEvs1.(dsh_scp1.(dsh_genEvs0.(dsh_scp0.(sn.(s.HeatingSystem_Functioning_Controller_On_Heater_Active_T11_enabledAfterStep))))))
